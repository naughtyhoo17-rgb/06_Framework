...
public class MemberController {
	...
	@GetMapping("checkEmail") // GET 방식 /member/checkEmail 요청 mapping
	...
	@ResponseBody
	@PutMapping("restoreDelFl")
	public int restoreDelFl(@RequestBody int memberNo) {
		
		return service.restoreDelFl(memberNo);
	}
